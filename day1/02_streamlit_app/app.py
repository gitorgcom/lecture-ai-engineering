...
# --- アプリケーション設定 ---
st.set_page_config(page_title="日本語 チャットボット", layout="wide")
...
# --- Streamlit アプリケーション ---
st.title("🤖 日本語 チャットボット")
st.write("GPT-2を基にした軽量な日本語チャットボットです。回答に対してフィードバックを行えます。")
st.markdown("---")
